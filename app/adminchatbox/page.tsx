...
const AdminChatbox: React.FC = () => {
  ...
  const sendBroadcast = async () => {
    if (!adminId || !broadcastMessage.trim()) return;
    try {
      await axios.post(
        `${BACKEND_URL}/messages/broadcast`,
        { content: DOMPurify.sanitize(broadcastMessage) },
        { withCredentials: true, timeout: 15000 }
      );
      toast.success("Broadcast sent successfully", { duration: 3000 });
      setBroadcastModalOpen(false);
      setBroadcastMessage("");
      fetchConversations(); // Refresh conversations to reflect new ones created by broadcast
    } catch (error) {
        ...
        <div className="flex justify-between items-center mb-4">
          ...
          <button
            ...
            className={`p-2 rounded-full ${
              isDarkMode ? "bg-[#005555] hover:bg-[#007575]" : "bg-[#005555] hover:bg-[#007575]"
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-20">
          ...
          >
            ...
            <textarea
              ...
              className={`w-full px-4 py-2 rounded-lg border focus:outline-none focus:ring-2 focus:ring-[#005555] transition resize-none h-32 ${
                isDarkMode
                  ? "bg-gray-700 text-gray-100 border-gray-600 placeholder-gray-400"
                  : "bg-white text-black border-gray-200 placeholder-gray-500"
              }`}
